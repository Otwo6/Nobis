        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                ...
                <div className="flex gap-3 w-full md:w-auto">
                    <button className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-[#1a2e55] border border-[#3b4f7a] hover:bg-[#253a66] text-white px-4 py-2.5 rounded-lg text-sm font-medium transition shadow-sm">
                        <AlertCircle className="w-4 h-4" /> Report an Issue
                    </button>
                    <button className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-transparent border border-white/40 hover:bg-white/5 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition">
